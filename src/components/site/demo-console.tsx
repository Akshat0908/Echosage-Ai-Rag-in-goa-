  ...
  return (
    <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
      ...
      <div className="relative lg:col-span-7">
        ...
        <span className="absolute -right-3 bottom-8 rotate-90 border-2 border-ink bg-sun px-3 py-1 font-mono text-[9px] font-bold tracking-[0.12em] text-sun-foreground uppercase">
          calibration active
        </span>
      </div>
    </div>
