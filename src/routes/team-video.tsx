...
export const Route = createFileRoute("/team-video")({
  head: () => ({
    meta: [
      { title: "Team Video — SandQuery Goa 2026" },
      {
        name: "description",
        content: "Watch our team talk about the sub-200ms voice RAG pipeline.",
      },
    ],
  }),
  component: TeamVideoPage,
});

function TeamVideoPage() {
  return (
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        <div className="mb-10 text-center">
          ...
          <h1 className="text-3d mt-4 font-display text-[clamp(2.4rem,7vw,5rem)] leading-[0.84] font-black">
            TEAM <span className="text-primary italic">video.</span>
          </h1>
        </div>
        ...
        <div className="mt-8 flex flex-col gap-3">
          <p className="text-center font-mono text-[11px] tracking-[0.16em] text-muted-foreground uppercase">
            watch us slowly lose our sanity trying to shave off 5ms of network latency.
          </p>
          <p className="text-center font-mono text-[11px] tracking-[0.16em] text-muted-foreground uppercase">
            if we look tired, it's because the HuggingFace API went to sleep and we didn't.
          </p>
          <p className="text-center font-mono text-[11px] tracking-[0.16em] text-muted-foreground uppercase">
            this video was sponsored by caffeine, panic, and sheer desperation to go to Goa.
          </p>
        </div>
      </section>
